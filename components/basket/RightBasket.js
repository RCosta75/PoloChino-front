...
return(
    ...
    <h3 className="text-center text-lg py-20" >RESUME DE LA COMMANDE</h3>
        <div className="mx-10 mt-5">
            ...
            <button className="block w-full rounded bg-black px-4 py-3 mt-10 text-lg font-medium text-white transition hover:scale-105" onClick={ ()=>{handlePaymentClick()}} > Procéder au paiement </button>
