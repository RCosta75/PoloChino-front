        ...
        <div className="flex items-center text-xl">
          ...
          <div className="ml-10 mt-10 flex-auto">
            ...
            className="px-4 py-2 border border-gray-200">
              ...
              <div className="flex items-center w-40 rounded border border-gray-200 mb-10 mt-4">
                <button
                  type="button"
              ...
              <button className="block w-full rounded bg-gray-900 px-4 py-3 text-lg font-medium text-white transition hover:scale-105" onClick={() => dispatch(removeCart(polo._id))}>
                Remove Article
              </button>
            </div>
          </div>
