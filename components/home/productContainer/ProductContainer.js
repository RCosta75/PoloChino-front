      ...
      <div className="flex justify-center pt-10">
        ...
        <div className="justify-end p-4">
          ...
          <select
            ...
            className="border-2 px-2 py-1 bg-gray-200 shadow-zinc-950 border-stone-900"
          >
        ...
        <div className="justify-end p-4">
          <label htmlFor="material" className="mr-2 text-xl">
            Matière :
          </label>
        ...
        {/* trier par la marque */}
        <div className="justify-end p-4">
          <label htmlFor="brand" className="mr-2 text-xl">
            Marque :
          </label>
          <select
            id="brand"
        ...
        {/* trier par la coupe */}
        <div className="p-4">
          <label htmlFor="coupe" className="mr-2 text-xl">
            Coupe :
          </label>
