...
<blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm w-[400px] sm:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-lg font-bold text-gray-900">@{review.user.username}</p>
          </div>
        </div>
        <div>
...
<blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm w-[400px] sm:p-8">
        ...
        <div>
            <input placeholder='TITLE' onChange={(e) => setTitle(e.target.value)} className='mt-5 px-4 font-semibold w-full'></input>
        <textarea className="mt-10 text-gray-700 w-full py-2 px-2 h-32" placeholder='YOUR REVIEW'></textarea>
        </div>
      </blockquote>
        {commentaire}
    </div>
