      ...
      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm w-[400px] sm:p-8">
        ...
        <div>
          ...
          <textarea
            ...
            value={msg}
            className="mt-10 text-gray-700 w-full py-2 px-2 h-24"
            placeholder="YOUR REVIEW"
          ></textarea>
          <button
            onClick={() => handleClick()}
            className="block w-full rounded bg-[#001021] px-3 py-2 text-sm font-medium text-stone-100 transition mt-5 hover:scale-105"
          >
            Add Review
          </button>
        </div>
