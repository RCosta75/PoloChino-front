  ...
  const people = [
    {
      name: "COSTA Raphael",
      role: "Technicien Fou",
      imageUrl: "/raphoutech.jpg",
      xUrl: "#",
      linkedinUrl: "#",
    },
    {
      name: "HO NGUYEN Nhat-Quan",
      role: "CEO",
      imageUrl: "/nhattech.jpg",
      xUrl: "#",
      linkedinUrl: "#",
    },
    {
    ...
    <div className="bg-white py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-6 text-lg/8 lg:text-2xl text-gray-600">
